...
-- Setup Quawke
local quawke = require("quawke")
quawke.init(apps.terminal, apps.terminal)
...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ modkey}, "`",
    	function() 
	    quawke.toggle(client)
	end,	
        {description="open quawke", group="launcher"}
    ),
    ...
    awful.key({ modkey, "Shift"}, "f",
        ...
        {description="open new firefox window", group="launcher"}
    ),
    -- help popup
    awful.key({ modkey }, "s",
    	function() 
